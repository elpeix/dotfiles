...
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-'#60b494'}
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
  TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
    ...
    #"xkb_layout 125 117"
    #"date_day #008464 255"
    "mode_indicator #335555 #dddddd"
    "date #008464 255 ${TMUX_POWERLINE_SEPARATOR_LEFT}"
    "time #005f4f 255 ${TMUX_POWERLINE_SEPARATOR_LEFT}"
