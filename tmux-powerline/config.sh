...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/cesc/.mail/inbox/new"

## mbox
# Path to the mbox to check.
export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/mail/cesc"

## mailcheck
# Optional path to mailcheckrc
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/cesc/.mailcheckrc"
# }
...
# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/cesc/.now_playing.log"
